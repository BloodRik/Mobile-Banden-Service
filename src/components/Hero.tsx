...
export default function Hero({ currentLang }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-t from-neutral-950/90 via-neutral-950/40 to-black/60 z-10" />
        ...
        <img
          ...
          className="w-full h-full object-cover object-center scale-[1.02] filter brightness-[0.85]"
      ...
      <motion.div
        style={{ y: yContent }}
        className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-24 text-center flex flex-col items-center"
        id="hero-content"
      >
        {/* Float Badge */}
        <motion.div
          ...
          className="mb-6 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-[#d4af37]/20 to-[#aa7c11]/10 border border-[#d4af37]/45 shadow-[0_0_15px_rgba(212,175,55,0.1)]"
        >
          <Award className="w-4 h-4 text-[#d4af37]" />
          <span className="text-xs font-sans font-semibold tracking-widest text-[#d4af37] uppercase">
            {t.hero.badge}
          </span>
        </motion.div>
        ...
        <motion.p
          ...
          className="mt-6 font-sans text-lg sm:text-2xl text-neutral-300 font-medium tracking-wide max-w-2xl"
          id="hero-subtitle"
        >
          {t.hero.subtitle}
        </motion.p>
        ...
        <motion.div
          ...
          className="mt-8 flex flex-wrap justify-center gap-x-8 gap-y-2 text-xs sm:text-sm font-sans font-semibold tracking-wider text-neutral-400 uppercase"
        >
        ...
        <motion.div
          ...
          className="mt-12 flex flex-col gap-4 w-full max-w-lg items-center px-4"
          id="hero-actions"
        >
          {/* Main Buttons Row */}
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
            ...
            <div className="flex gap-4 sm:flex-1">
              ...
              <a
                ...
                className="flex-1 inline-flex items-center justify-center gap-2.5 px-4 py-4 rounded-full bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-sm sm:text-base transition-all shadow-lg active:scale-95"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 inline-flex items-center justify-center gap-2.5 px-4 py-4 rounded-full bg-sky-600 hover:bg-sky-500 text-white font-bold text-sm sm:text-base transition-all shadow-lg active:scale-95"
              >
                <svg className="w-5 h-5 fill-current text-white" viewBox="0 0 24 24">
          ...
          <button
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-8 py-3.5 rounded-full bg-neutral-900/80 hover:bg-neutral-800 text-white font-bold text-sm uppercase tracking-widest transition-all border border-neutral-800 hover:border-[#d4af37] shadow-lg active:scale-95 group"
          >
        ...
        <motion.div
          ...
          className="absolute bottom-8 cursor-pointer p-2 rounded-full border border-neutral-800 bg-neutral-950/50 backdrop-blur-sm text-neutral-400 hover:text-[#d4af37] hover:border-[#d4af37]/40 transition-all z-20"
